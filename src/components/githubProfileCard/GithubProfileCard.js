      ...
      <div className="main" id="contact">
        ...
        <div className="row">
          ...
          <div className="image-content-profile">
            <img src="https://cdn.discordapp.com/attachments/791984087488266250/793420999218954300/received_1470079969757041.jpg" alt={prof.name} className="profile-image" />
          </div>
        </div>
      </div>
    </Fade>
